...
## Overview
Project Rakan is a serverless IoT automation backend using AWS IoT Core, Lambda, and DynamoDB. Nano esp32 WiFi devices publish telemetry to AWS IoT, triggering Lambda-based automation and device state management.
...
Stores current state and desired state of IoT devices (nano esp32).
